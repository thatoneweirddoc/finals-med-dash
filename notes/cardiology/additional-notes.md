...
system: "Cardiology"
sources: [Cardiovascular (ANU) — arhythmias]
tags: [Additional, QRS, AV, MI]
updated: "2026-08-14"
---
...
### Cardiovascular (ANU) — arhythmias — Additional Notes

This section runs in four blocks: the general definition, then bradyarrhythmias, supraventricular tachyarrhythmias and ventricular arrhythmias.

#### Definition and presentation

**The short version**

- An arrhythmia is any rhythm that is **not sinus rhythm with normal AV conduction**.
- Symptoms are non-specific and shared across all types — palpitations, dizziness, syncope, chest discomfort, dyspnoea.
- So the diagnosis is made on the **ECG**, not the history: rate, rhythm regularity, P–QRS relationship, QRS width.

| Definition | rhythm that is not sinus rhythm, with normal AV conduction |
| --- | --- |
...
- All are **narrow-QRS** unless there is aberrancy or an accessory pathway conducting antidromically — a wide QRS should not be assumed supraventricular.
- **Atrial origin:** flutter = sawtooth P waves at 250–350 (II, III, aVF), AF = irregularly irregular with **indiscernible P waves**, MAT = irregularly irregular with **≥3 P wave morphologies** in COPD/PE/CHF.
- **AV node origin:** AVRT/AVNRT are the paroxysmal SVTs at **150–250, abrupt onset**; AVRT has an accessory pathway with P after the QRS, AVNRT hides the P in the QRS.
- **WPW** is the one with the structural giveaway: **short PR + delta wave + widened QRS** via the bundle of Kent.

| Type | Aetiology | ECG FIndings |
| --- | --- | --- |
| **Atrial Origin** | | |
| Supraventricular premature beats | Physiological, electrolyte imbalances, underlying CVD | P wave abnormalities or absent P waves |
| Sinus tachycardia | Sympathetic activation, vagal withdrawal on SA Notes | Rate: regularNormal P wave and narrow QRS |
| Atrial flutter | Macro re-entrant rhythms within atriaTreat similar to AF ![](notes/images/cardiovascular-anu/img021.jpg) | Rate: atrial 250–350; regular<br>• P waves before every QRS<br>• Sawtooth appearance of regular P waves especially in leads II, III, aVF (what ratio?) <br>• Narrow QRS complex<br>• 1:1 conduction has ↑ risk of VT |
| Atrial fibrillation | Below ![](notes/images/cardiovascular-anu/img022.jpg) | Rhythm: irregularly irregular<br>• Rate: 350–450 bpm <br>• P-waves are indiscernible<br>• Narrow QRS complex |
| Atrial tachycardia<br>Focal atrial tachycardia | Single ectopic focus in the atrium | Very abrupt onset<br>• Rate: 150–250; regular<br>• P wave (depends on site of ectopic focus) but occurs before narrow QRS |
| Multifocal atrial tachycardia (MAT) | Multiple ectopic foci in the atrium in pulmonary (COPD, PE) and cardiac (CHF) | Very abrupt onset with rate variation<br>• Rhythm: irregularly irregular<br>• Rate: 150–250<br>• Discernible P waves with ≥ 3 different P wave morphologies<br>• Narrow QRS complex<br>• Treat with theophylline ⚠ **SOURCE ERROR — theophylline **causes and aggravates** MAT and is one of the drugs to stop. Treat the underlying cause (hypoxia, COPD exacerbation, electrolytes); if rate control is needed use **verapamil or a beta-blocker if not contraindicated**, and consider **magnesium**. Cardioversion does not work.** |
| **AV Node Origin** | | |
| Atrioventricular reentry tachycardia (AVRT) | Paroxysmal SVT with accessary pathway between atria and ventricles | Very abrupt onset<br>• Rate: 150–250; regular<br>• P inverted (in II, III and aVF and/or upright in aVR) and occur after the QRS complex<br>• Orthodromic AVRT: narrow QRS<br>• Antidromic AVRT: wide QRS; delta waves |
| AV nodal reentry tachy (AVNRT) | Paroxysmal SVT with dysfunctional AV node | Rate: 150–250; regularP waves occur during (not visible) or after the narrow QRS complex |
